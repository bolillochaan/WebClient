    ...
    function f(t, s, u) {
        ...
        function p(t) {
            for (var n = [], i = !0, s = 0; t.validators[s]; s++) {
                ...
                if (l[0] = t.input.value,
                !a.fn.apply(t.input, l) && (i = !1,
                "function" == typeof a.msg ? n.push(a.msg(t.input.value, l)) : "string" == typeof a.msg ? n.push(r.apply(a.msg, l)) : a.msg === Object(a.msg) && a.msg[o] ? n.push(r.apply(a.msg[o], l)) : t.messages[o] && t.messages[o][a.name] ? n.push(r.apply(t.messages[o][a.name], l)) : e[o] && e[o][a.name] && n.push(r.apply(e[o][a.name], l)),
                !0 === a.halt))
                    break
            }
            return t.errors = n,
        ...
        function m(e) {
            ...
            var r = function(e, r) {
              ...
              , t = null
              , n = null;
            return (t = f.config.classTo === f.config.errorTextParent ? r : r.querySelector("." + f.config.errorTextParent)) && ((n = t.querySelector(".pristine-error")) || ((n = document.createElement(f.config.errorTextTag)).className = "pristine-error " + f.config.errorTextClass,
            t.appendChild(n),
        ...
        function d(e) {
            var r = m(e)
              , t = r[0]
              , n = r[1];
            t && (t.classList.remove(f.config.successClass),
        ...
        function h(e) {
            var r = function(e) {
                var r = m(e)
                  , t = r[0]
                  , n = r[1];
                return t && (t.classList.remove(f.config.errorClass),
